...
public class SpawnManager : MonoBehaviour //Classe criada para gerenciar o surgimento dos inimigos
{
    ...
    private float tempoDesdeUltimoSpawn; // controla o tempo desde de que o ulyimo inimigo ofi spawnado
    ...
    private void Update()
    {
        ...
        /*Se o jogo está no processo de spawning (spawnando == true), 
         * ele continua spawnando inimigos com base no tempo (inimigosPorSegundo).
         * A cada spawn, decrementa inimigosParaSpawnar, incrementa inimigosVivos, 
         * e reseta o contador tempoDesdeUltimoSpawn*/
    }
    ...
    private IEnumerator IniciarOnda()//Coroutine que espera um tempo (tempoEntreOndas), antes de começar a gerar inimigos para a nova onda. Também calcula quantos inimigos serão spawnados usando InimigosPorOnda().
    {
    ...
    /*O SpawnManager controla o fluxo de ondas de inimigos no jogo. 
     * Ele gerencia a criação de inimigos, ajusta a dificuldade automaticamente ao longo do tempo, 
     * e sincroniza o ciclo de ondas, determinando quando novas ondas começam e terminam. 
     * A lógica é fundamental para manter a progressão do desafio, escalando o número de inimigos conforme o jogo avança.*/
}