...
public class Turrets : MonoBehaviour
{
    ...
    /*Este script controla o comportamento de uma torre no jogo. 
     * Ele busca inimigos dentro de seu alcance, gira para mirar 
     * no inimigo mais próximo, e atira projéteis periodicamente. 
