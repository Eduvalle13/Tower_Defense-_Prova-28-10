...
public class TorreArqueira : ITorreDano
{
    ...
    public float Alcance => 2; //Uma propriedade somente leitura (get), que define o alcance da torre como 2. Isso significa que a torre só pode atacar inimigos que estejam a uma distância de 2 ou menos.
